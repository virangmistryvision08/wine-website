              ...
              <div className="mx-auto">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-10 mt-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-1 gap-5 bg-[#f7f7f7] p-6 rounded-lg h-fit">
                    ...
                    {/* Buttons */}
                    <div>
                      <button onClick={() => navigate("/checkout")} type="button" className="w-full mt-6 bg-[#EED291] hover:bg-black hover:text-white transition duration-300 cursor-pointer py-3 rounded-full font-semibold hidden md:block">
                        PROCEED TO CHECKOUT
                      </button>

                      <button onClick={() => navigate("/shop")} className="w-full mt-0 md:mt-3 bg-[#EED291] hover:bg-black hover:text-white transition duration-300 cursor-pointer py-3 rounded-full font-semibold">
                        CONTINUE SHOPPING
                      </button>
                    </div>
                  </div>
