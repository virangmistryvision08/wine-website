        ...
        <div className="w-[96%] mx-auto">
          <div className="absolute text-white flex flex-col gap-3 bottom-5 xl:bottom-10 ">
            <h4 className="font-[Urbanist] flex items-center font-bold text-xs md:text-base capitalize">
              <span className="cursor-pointer hover:text-[#EED291]" onClick={() => navigate("/")}>Home</span> <span className="mx-2"><i class="fa-solid fa-angle-right"></i></span> {productType ? <span className="text-white">{productType}</span> : <><span className="cursor-pointer hover:text-[#EED291]" onClick={() => navigate("/shop")}>Shop</span>
