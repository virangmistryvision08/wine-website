...
import UserLoginDrawer from "./drawers/UserLoginDrawer";
...
function Navbar() {
  ...
  useEffect(() => {
    if (cartOpen || isDrawerOpen || isUserDrawer) {
  ...
  }, [cartOpen, isDrawerOpen, isUserDrawer]);
                  ...
                  >
                    {[
                      ...
                      <NavLink
                        key={label.name}
                        to={label.to}
                        className="block px-4 py-2 hover:text-[#EED291] hover:underline border-b border-gray-700 last:border-none"
                      >
                        {label.name}
                      </NavLink>
                    ))}
  ...
  hover:after:w-full hover:text-[#EED291]"
              ...
              <button
                ...
                className="bg-[#EED291] px-9 py-4 rounded-full font-semibold hidden xl:block cursor-pointer hover:bg-transparent hover:outline hover:outline-[#EED291] hover:text-[#EED291] transition-all duration-500"
              >
                CONTACT US
              </button>
              ...
              <i
                className={`fa-solid fa-bars block text-2xl xl:!hidden ${
                  (isWhiteBG === "cart" ||
                    isWhiteBG === "register" ||
                    isWhiteBG === "account/login" ||
                    isWhiteBG === "account/verify-email" ||
        ...
        : "text-gray-800 cursor-pointer"
            ...
            <div className="p-5 bg-white">
              ...
              <button
                ...
                type="button"
                className="mt-4 w-full py-3 border border-[#EED291] bg-[#EED291] hover:bg-white hover:outline hover:outline-[#EED291] transition duration-300 cursor-pointer font-semibold rounded-full text-lg"
              >
                Checkout
              </button>
