        ...
        <>
            <div className='min-h-screen w-[90%] xl:w-[80%] py-10 md:py-20 mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10'>
                <div className='md:w-1/2 flex flex-col gap-8'>
                    ...
                    <button className="bg-[#EED291] px-12 py-4 rounded-full font-semibold  hover:bg-black hover:outline hover:outline-[#EED291] hover:text-[#EED291] transition-all duration-300 cursor-pointer w-fit font-[Urbanist]">DISCOVER MORE</button>
                </div>
