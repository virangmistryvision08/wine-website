...
const AboutUs_Bergdolt = () => {
  ...
  return (
    <>
      ...
      <section className="w-full">
        <div className="w-[90%] mx-auto md:pb-16 xl:py-20 space-y-10 font-[Urbanist]">
          ...
          <Swiper
            slidesPerView={1.5}    // Mobile default → 1.5 images
            spaceBetween={20}
            centeredSlides={false}
            loop={true}
            pagination={{ clickable: true }}
            breakpoints={{
              480: {               // Small Phones / Mobile
                slidesPerView: 1.5,
              },
              768: {               // Tablets
                slidesPerView: 1.5,
